...
export class InvoiceService {
  ...
  async createInvoice(_userId: number, input: CreateInvoiceDTO) {
    ...
    /*
     * @TODO faire une transaction sql dans le cas où une row fail
     * on ne veut pas incrémenter le numéro de facture en cas d'erreur, detoute façon le numéro de facture sera attribué au moment de la validation
     */
